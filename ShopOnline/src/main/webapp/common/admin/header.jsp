		...
		<div class="page-actions">
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu pull-left" role="menu">
					<li>
						<a href="<c:url value="/admin/category/create"></c:url>">
						<i class="icon-tag"></i> New Category </a>
					</li>
					<li>
						<a href="<c:url value="/admin/user/create"></c:url>">
						<i class="icon-users"></i> New User </a>
					</li>
					<li>
						<a href="<c:url value="/admin/product/create"></c:url>">
							<i class="icon-basket"></i> New Product </a>
					</li>
					<li>
						<a href="<c:url value="/admin/userRole/create"></c:url>">
							<i class="icon-users"></i> New User Role </a>
					</li>
