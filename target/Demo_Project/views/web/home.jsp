              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="<c:url value="/image?fname=products/${proList.images }"></c:url>" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="<c:url value="/image?fname=products/${proList.images }"></c:url>" class="btn btn-default fancybox-button">Zoom</a>
                  ...
                  <a href="<c:url value="/member/cart/add?pId=${proList.productId}&quantity=1"/>" class="btn btn-default add2cart">Add to cart</a>
							...
							<div class="product-page product-pop-up${proList.productId}">
								<div class="row">
									...
									<div class="col-md-6 col-sm-6 col-xs-9">
										...
										<h4>Category: ${proList.category.categoryName} - Shop: ${proList.seller.sellerName }</h4>
		...
		<div class="row margin-bottom-40 ">
						...
						<li class="list-group-item clearfix"><a
							...
							<img
								...
								class="fa fa-angle-right"></i>${cateList.categoryName}</a></li>
									...
									<!-- BEGIN fast view of a product -->
						<div id="product-pop-upp${proTopAmount.productId }" style="display: none; width: 700px;">
							<div class="product-page product-pop-upp${proTopAmount.productId }">
								<div class="row">
									<div class="col-md-6 col-sm-6 col-xs-3">
										<div class="product-main-image">
											<img src="<c:url value="/image?fname=products/${proTopAmount.images }"></c:url>"
												alt="Cool green dress with red bell 12" class="img-responsive">
										</div>
										<div class="product-other-images">
											<a href="<c:url value="/image?fname=products/${proTopAmount.images }"></c:url>" class="active"><img alt="Berry Lace Dress"
												src="<c:url value="/image?fname=products/${proTopAmount.images }"></c:url>"></a>
											<a href="<c:url value="/image?fname=products/${proTopAmount.images }"></c:url>"
												src="<c:url value="/image?fname=products/${proTopAmount.images }"></c:url>"></a>
											<a href="<c:url value="/image?fname=products/${proTopAmount.images }"></c:url>"><img alt="Berry Lace Dress"
												src="<c:url value="/image?fname=products/${proTopAmount.images }"></c:url>"></a>
										</div>
									</div>
									<div class="col-md-6 col-sm-6 col-xs-9">
										<h2>${proTopAmount.productName}</h2>
										<div class="price-availability-block clearfix">
											<div class="price">
												<strong><span>$</span>${proTopAmount.price }</strong> <em>$<span>${proTopAmount.price/0.8 }</span></em>
											</div>
												<div class="availability">
												Số lượng tồn: <strong>${proTopAmount.amount}</strong>
											</div>
										</div>
										<div class="description">
											<p>${proTopAmount.description }</p>
										</div>
										<div class="product-page-options">
											<div class="pull-left">
												<label class="control-label">Size:</label> <select
										...
										<div class="product-page-cart">
											...
											<button class="btn btn-primary" type="submit">Cho vào giỏ hàng</button>
											<a href="<c:url value="/product/detail?productId=${proTopAmount.productId }"></c:url>" class="btn btn-default">Xem chi tiết</a>
										</div>
									</div>
			...
			<div class="col-md-9 col-sm-8">
				...
				<div class="owl-carousel owl-carousel3">
					<c:forEach items="${productListNew}" var="proTopAmount">
						<div>
							<div class="product-item">
								<div class="pi-img-wrapper">
									<img src="<c:url value="/image?fname=products/${proTopAmount.images }"></c:url>"
									...
									<div>
										<a href="<c:url value="/image?fname=products/${proTopAmount.images }"></c:url>"
											...
											href="#product-pop-upp${proTopAmount.productId}"
											class="btn btn-default fancybox-fast-view">View</a>
									</div>
								</div>
								<h3>
									<a href="shop-item.html">${proTopAmount.productName}</a>
								</h3>
								<div class="pi-price">$${proTopAmount.price}</div>
								<a href="<c:url value="/member/cart/add?pId=${proList.productId}&quantity=1"/>" class="btn btn-default add2cart">Add to cart</a>
									...
									<div class="col-md-6 col-sm-6 col-xs-9">
										...
										<div class="price-availability-block clearfix">
											<div class="price">
												...
												<div class="availability">
												Số lượng tồn: <strong>${proTopAmount.stoke}</strong>
											</div>
										</div>
										<div class="description">
											<p>${proTopAmount.description }</p>
			...
			<div class="col-md-6 two-items-bottom-items">
				...
				<div class="owl-carousel owl-carousel2">
					<c:forEach items="${productListNew}" var="proTopAmount">
								...
								<div class="pi-img-wrapper">
									...
									<div>
										<a
										 ...
										 <a
											href="#product-pop-uppp${proTopAmount.productId}"
											class="btn btn-default fancybox-fast-view">View</a>
									</div>
								</div>
								<h3>
						...
						<!-- BEGIN fast view of a product -->
						<div id="product-pop-uppp${proTopAmount.productId }" style="display: none; width: 700px;">
							<div class="product-page product-pop-uppp${proTopAmount.productId }">
								<div class="row"> 
									<div class="col-md-6 col-sm-6 col-xs-3">
										<div class="product-main-image">
											<img src="<c:url value="/image?fname=products/${proTopAmount.images }"></c:url>"
